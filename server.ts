...
app.post('/api/ai/mermaid', async (req, res) => {
  ...
  // Generate fallback diagram code for offline or error cases
...
- Style: Modern dark mode classroom palette (background: #0f172a or transparent, stroke: #818cf8, #34d399, #f59e0b, #ec4899, text: #f8fafc)
