              ...
              <nav className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <button 
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-2 rounded-xl text-xs font-semibold transition-all ${activeTab === 'blogs' ? 'bg-indigo-600 text-white shadow-lg' : 'text-slate-400 hover:text-white hover:bg-white/5'}`}
                  >
                    <span>💎</span>
                    {sidebarOpen && 'Blogs'}
                  </button>
