  ...
  useEffect(() => {
    ...
    const { data: { subscription } } = supabase.auth.onAuthStateChange(async (event, session) => {
      ...
      if (session) {
        ...
        console.log("[USER_OBJECT]:", JSON.stringify(debugObj.user, null, 2));
      } else {
        debugObj.session = null;
        debugObj.user = null;
        console.log("[SESSION]: null");
        console.log("[USER_OBJECT]: null");
      }
      ...
      if (supabaseUser) {
        ...
        try {
          ...
          debugObj.redirectReason = "Authentication / Profile parsing crashed: " + (err.message || String(err));
          debugObj.fileCausingRedirect = "/src/App.tsx inside onAuthStateChange outer catch block";
          console.log("[REDIRECT_REASON]:", debugObj.redirectReason);
        ...
        debugObj.redirectReason = "No session or user found in authStateChange";
        debugObj.fileCausingRedirect = "/src/App.tsx inside onAuthStateChange else block";
        console.log("[REDIRECT_REASON]:", debugObj.redirectReason);
        console.log("[FILE_CAUSING_REDIRECT]:", debugObj.fileCausingRedirect);
