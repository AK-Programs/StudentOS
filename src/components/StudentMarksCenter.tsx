...
export default function StudentMarksCenter({ showNotification }: any) {
  ...
  useEffect(() => {
    ...
    const fetchStudents = async () => {
      ...
      try {
        ...
        const studs = snaps.docs.map(d => d.data() as UserProfile);
  ...
  const handleSaveMarks = () => {
    ...
    // Save these marks and notify
    sendNotificationToUsers({
      title: '💯 Marks Published',
      message: `Your academic performance scores for ${examType} have been published.`,
      type: 'marks',
      specificUserId: selectedStudent.email
  ...
  const handleGenerateReport = () => {
    ...
    sendNotificationToUsers({
      ...
      message: `Your official report card has been generated for ${examType}. Check your academic profile.`,
      type: 'marks',
      specificUserId: selectedStudent.email
    }).catch(e => console.error(e));
