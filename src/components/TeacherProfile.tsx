        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
          ...
          <div className="flex-1 space-y-4 w-full">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-400">Assigned Classes</label>
                <div className="text-sm px-4 py-3 bg-white/5 rounded-xl text-white font-medium">{(currentUser.assignedGrades || []).join(', ') || 'None Assigned'}</div>
              </div>
              <div className="space-y-1">
                <label className="text-xs font-bold text-slate-400">Assigned Sections</label>
                <div className="text-sm px-4 py-3 bg-white/5 rounded-xl text-white font-medium">{(currentUser.assignedSections || []).join(', ') || 'None Assigned'}</div>
              </div>
            </div>
          </div>
        </div>
