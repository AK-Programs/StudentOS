...
const resolvedApiKey = env.VITE_FIREBASE_API_KEY || firebaseConfig.apiKey;
const resolvedAuthDomain = env.VITE_FIREBASE_AUTH_DOMAIN || firebaseConfig.authDomain;
const resolvedProjectId = env.VITE_FIREBASE_PROJECT_ID || firebaseConfig.projectId;
const resolvedStorageBucket = env.VITE_FIREBASE_STORAGE_BUCKET || firebaseConfig.storageBucket || "studentos-ff6fe.firebasestorage.app";
const resolvedMessagingSenderId = env.VITE_FIREBASE_MESSAGING_SENDER_ID || firebaseConfig.messagingSenderId;
const resolvedAppId = env.VITE_FIREBASE_APP_ID || firebaseConfig.appId;
const resolvedMeasurementId = env.VITE_FIREBASE_MEASUREMENT_ID || firebaseConfig.measurementId;
const resolvedFirestoreDatabaseId = env.VITE_FIREBASE_FIRESTORE_DATABASE_ID || firebaseConfig.firestoreDatabaseId;
